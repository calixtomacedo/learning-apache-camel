...
public class ControllerAdviceExceptionsHandler {
    ...
    public ResponseEntity<ResponseErrorMessage> exceptionsHandler(Exception exception) {
    ...
    public ResponseEntity<List<ResponseErrorFields>> methodArgumentNotValidHandler(MethodArgumentNotValidException validException) {
    ...
    public ResponseEntity httpRequestMethodNotSupportedHandler(HttpRequestMethodNotSupportedException exception) {
